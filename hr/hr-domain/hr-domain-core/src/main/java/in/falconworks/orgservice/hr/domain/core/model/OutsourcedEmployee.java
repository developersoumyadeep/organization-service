...
import in.falconworks.orgservice.hr.domain.core.event.OutsourcedEmployeeCreatedEvent;
import in.falconworks.orgservice.hr.domain.core.event.AddressChangedEvent;
import in.falconworks.orgservice.hr.domain.core.event.EmailChangedEvent;
import in.falconworks.orgservice.hr.domain.core.event.MobileNumberChangedEvent;
...
public class OutsourcedEmployee implements AggregateRoot {
    ...
    private OutsourcedEmployee(Builder builder) {
    ...
    public static class Builder {
        ...
        public OutsourcedEmployee build() {
            return new OutsourcedEmployee(this);
        }
    }
}
